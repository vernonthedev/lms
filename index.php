...
<body>
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <img src="image/wiro.png" alt="Wiro Finance Loan Management System">
	</nav>
    <div class="container">
	...
	<nav class="navbar fixed-bottom navbar-success bg-success">
		<label style="color:#ffffff;">&copy; Copyright Wiro Finance - Loan Management System</label>
